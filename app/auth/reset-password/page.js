    ...
    <main>
      <section>
        ...
        {passwordResetStatus ? (
          <div className="mt-10">
            <div className="min-h-screen bg-us_blue rounded-t-3xl w-full flex items-center justify-center">
              <div className="flex items-center justify-center flex-col px-5">
                ...
                <p className="text-white tracking-wide mt-5 text-center text-[16px] font-semibold">
          ...
          <div className="mt-10 container-sm mx-auto">
            ...
            <div className="flex items-center justify-center mt-10">
              <div className="flex flex-col gap-2">
                <label className="text-sm text-sub_text_2">Confirm Password</label>
                <div className="input">
                  <input
                    className="text-sm text-black"
                    type="password"
...
// Wrap with Suspense to handle client-side only rendering
